...
public class FilterHelperTests {
    ...
    public void lessThenFiveTest() {
        ...
        Assertions.assertEquals(expectedList, FilterHelper.filtrator(inputList, x -> x < 5));
    }
    ...
    public void moreThenTenTest() {
        ...
        Assertions.assertEquals(expectedList, FilterHelper.filtrator(inputList, x -> x > 10));
    }
    ...
    public void containedInArrayTest() {
        ...
        Assertions.assertEquals(expectedList, FilterHelper.filtrator(inputList, x -> etalon.contains(x)));
    }
    ...
    public void singleValuesTest() {
        ...
        Assertions.assertEquals(expectedList, FilterHelper.filtrator(inputList, x -> {
            {
