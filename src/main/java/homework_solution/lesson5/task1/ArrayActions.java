...
public class ArrayActions {
    ...
    /**
     * Создает двумерный массив, где каждая i-ая строка является результатом
     * деления элемента dividends[i] на каждый элемент массива dividers.
     * В случае деления на ноль значение результата равно -1.
     *
